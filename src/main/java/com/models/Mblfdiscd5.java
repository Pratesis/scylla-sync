...
public class Mblfdiscd5  implements java.io.Serializable {
    ...
    public Mblfdiscd5(BigDecimal id, Date mtgl, String mslsno, String kode, BigDecimal xno, BigDecimal minrange, BigDecimal maxrange, String tkode, BigDecimal tpercent, BigDecimal tvalue) {
       this.id = id;
       this.mtgl = mtgl;
       this.mslsno = mslsno;
       this.kode = kode;
