...
public class Mblfdiscd6  implements java.io.Serializable {
    ...
    public Mblfdiscd6(BigDecimal id, Date mtgl, String mslsno, String kode, String pcode, BigDecimal xno, BigDecimal minqty, BigDecimal maxqty, String xminqty, String xmaxqty, BigDecimal kpercent) {
       this.id = id;
       this.mtgl = mtgl;
       this.mslsno = mslsno;
       this.kode = kode;
